...
if s:style == 'plain'
	...
	let s:p.tabline.middle = [
				\ [s:mono0, s:mono1, s:c_mono0, s:c_mono1]]
	let s:p.tabline.right = [
				\ [s:mono4, s:mono1, s:c_mono4, s:c_mono1],
				\ [s:mono0, s:mono4, s:c_mono0, s:c_mono4]]
	let s:p.tabline.left = [
...
" {'inactive': {'right': [['#707880', '#303030', 7, 236], [...]], 'middle': [[...]], 'left': [[...], [...]]}, 'replace': {'left': [['#1d1f21', '#cc6666', 234, 9], ['#c5c8c6', '#373b41', 15, 8]]}, 'normal': {'right': [['#1d1f21', '#707880', 234, 7], ['#1d1f21', '#707880', 234, 7]], 'middle': [['#707880', '#282a2e', 7, 0]], 'warning': [['#1d1f21', '#de935f', 234, 3]], 'left': [['#1d1f21', '#b5bd68', 234, 10], [...]], 'error': [['#1d1f21', '#cc6666', 234, 9]]}, 'tabline': {'right': [['#707880', '#282a2e', 7, 0], ['#1d1f21', '#707880', 234, 7]], 'middle': [['#1d1f21', '#282a2e', 234, 0]], 'left': [['#707880', '#282a2e', 7, 0]], 'tabsel': [['#1d1f21', '#b5bd68', 234, 10]]}, 'visual': {'left': [['#1d1f21', '#de935f', 234, 3], [...]]}, 'insert': {'left': [['#1d1f21', '#81a2be', 234, 12], [...]]}}
